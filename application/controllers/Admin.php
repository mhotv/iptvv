...
class Admin extends CI_Controller {   
    ...
    function country_setting($param1 = '', $param2 = ''){
        if ($this->session->userdata('admin_is_login') != 1)
            redirect(base_url(), 'refresh');
            /* start menu active/inactive section*/
            $this->session->unset_userdata('active_menu');
            $this->session->set_userdata('active_menu', '222');
            /* end menu active/inactive section*/
        if ($param1 == 'update') {
            $publish = $this->input->post('country_to_primary_menu');
            if($publish =='on'):
                $data['value'] = '1';
            ...
            redirect(base_url() . 'admin/country_setting/', 'refresh');                       
        }
        $data['page_name']      = 'country_setting';
        $data['page_title']     = 'Country Setting';
        $this->load->view('admin/index', $data);
    }
    ...
    function genre_setting($param1 = '', $param2 = ''){
        if ($this->session->userdata('admin_is_login') != 1)
            redirect(base_url(), 'refresh');
            /* start menu active/inactive section*/
            $this->session->unset_userdata('active_menu');
            ...
            /* end menu active/inactive section*/
        if ($param1 == 'update') {
            $publish = $this->input->post('genre_to_primary_menu');
            if($publish =='on'):
                $data['value'] = '1';
            ...
            $this->session->set_flashdata('success', 'Setting update successed.');
            redirect(base_url() . 'admin/genre_setting/', 'refresh');                       
        }
        $data['page_name']      = 'genre_setting';
        $data['page_title']     = 'Genre Setting';
        $this->load->view('admin/index', $data);
    }
    ...
    function theme_options($param1 = '', $param2 = ''){
        if ($this->session->userdata('admin_is_login') != 1)
            ...
            if ($param1 == 'update') {
             ...
             // langing page background image
            if($_FILES['landing_page_image']['tmp_name'] !='' && $_FILES['landing_page_image']['tmp_name'] !=NULL) :
                 $landing_page_image_path = 'uploads/landing_page/bg.jpg';
                 move_uploaded_file($_FILES['landing_page_image']['tmp_name'], $landing_page_image_path);

                 $data['value'] = base_url().$landing_page_image_path;
                 $this->db->where('title' , 'landing_page_image_url');
                 $this->db->update('config' , $data);
             endif; 
             $this->session->set_flashdata('success', 'Setting update successed.');           
    ...
    function copyright_privacy($param1 = '', $param2 = ''){
        ...
        if ($param1 == 'update') {
            ...
            $this->session->set_flashdata('success', 'Copyright and privacy setting update successed');
            redirect(base_url() . 'admin/copyright_privacy/', 'refresh');
        }
        $data['page_name']      = 'copyright_privacy';
        $data['page_title']     = 'Copyright Management';
        $this->load->view('admin/index', $data);
    }
    ...
    function push_notification_setting($param1 = '', $param2 = ''){
        ...
        if ($param1 == 'update') {
            ...
            redirect(base_url() . 'admin/push_notification_setting/', 'refresh');
        }
    ...
    function send_push_notification($param1 = '', $param2 = ''){
        ...
        if ($param1 == 'send') {
            ...
            redirect(base_url() . 'admin/send_push_notification/', 'refresh');
        }
    ...
    function send_movie_notification($type='',$videos_id = '',$param2=''){
        ...
        if($param2 == 'tv'):
            redirect(base_url() . 'admin/tvseries/', 'refresh');
        else:
    ...
    function admob_setting($param1 = '', $param2 = ''){
        ...
        if($param1=='update'): 
            ...
            $this->session->set_flashdata('success', 'Admob Setting changed.');
            redirect(base_url() . 'admin/admob_setting', 'refresh');
        endif;
        $data['page_name']  = 'admob_setting';
        $data['page_title'] = 'Admob Setting';
        $this->load->view('admin/index', $data);
    }
    ...
    function ima_ads_setting($param1 = '', $param2 = ''){
        ...
        if($param1=='update'): 
            ...
            redirect(base_url() . 'admin/ima_ads_setting', 'refresh');
        endif;
