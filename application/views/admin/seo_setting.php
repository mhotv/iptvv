    ...
    <!-- panel  -->
      <div class="panel panel-border panel-primary col-md-6">
        <div class="panel-heading">
          <h3 class="panel-title">Basic SEO</h3>
        </div>
        <div class="panel-body"> 
          <!-- panel  -->
          <div class="alert alert-info col-sm-12 col-md-offset-3"><p><strong>Note: </strong>Leave blank if you not want to use any feature.</p></div>
          
          <div class="form-group row">
            <label class=" col-sm-4 control-label">XML Sitemap URL(sitemap.xml):</label>
            <div class="col-sm-8">
              <a href="<?php echo base_url('sitemap.xml') ?>" target="_blank"><?php echo base_url('sitemap.xml') ?></a>
            </div>
          </div>
          <div class="form-group">
            <label class=" col-sm-12 control-label">Author Name</label>
            <div class="col-sm-12">
              <input type="text" name="author" class="form-control" value="<?php echo $this->db->get_where('config' , array('title' =>'author'))->row()->value;?>">
            </div>
          </div>
          <div class="form-group">
            <label class=" col-sm-12 control-label">Google Analytics ID</label>
            <div class="col-sm-12">
      ...
      <div class="panel panel-border panel-primary col-md-6">
        <div class="panel-heading">
          <h3 class="panel-title">Home Page SEO</h3>
        </div>
        <div class="panel-body"> 
          <div class="form-group">
            <label class=" col-sm-12 control-label">SEO Title</label>
            <div class="col-sm-12">
          ...
          <div class="form-group">
            <label class=" col-sm-12 control-label">SEO Keyword</label>
            <div class="col-sm-12">
      ...
      <div class="panel panel-border panel-primary col-md-6">
        <div class="panel-heading">
          <h3 class="panel-title">Movie Page SEO</h3>
        </div>
        <div class="panel-body"> 
          <div class="form-group">
            <label class=" col-sm-12 control-label">SEO Title</label>
          ...
          <div class="form-group">
            <label class="control-label col-md-12">SEO Meta Description</label>
            <div class="col-sm-12">
      ...
      <div class="panel panel-border panel-primary col-md-6">
        <div class="panel-heading">
          <h3 class="panel-title">Tv-Series Page SEO</h3>
        </div>
        <div class="panel-body">
          <div class="form-group">
            <label class="col-sm-12 control-label">SEO Title</label>
          ...
          <div class="form-group">
            <label class="col-sm-12 control-label">SEO Meta Description</label>
            <div class="col-sm-12">
      ...
      <div class="panel panel-border panel-primary col-md-6">
        <div class="panel-heading">
          <h3 class="panel-title">Live TV Page SEO</h3>
        </div>
        <div class="panel-body">
          <div class="form-group">
      ...
      <div class="panel panel-border panel-primary col-md-6">
        <div class="panel-heading">
          <h3 class="panel-title">Blog Page SEO</h3>
        </div>
        <div class="panel-body">
          <div class="form-group">
            <label class=" col-sm-12 control-label">SEO Title</label>
