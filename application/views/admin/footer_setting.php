    ...
    <div class="col-md-12">
      <div class="panel panel-border panel-primary">
        <div class="panel-heading">
          <h3 class="panel-title"><?php echo tr_wd('footer_setting'); ?></h3>
        </div>
        <div class="panel-body"> 
          <!-- panel  -->
          
          <div class="form-group row">
            <label class=" col-sm-3 control-label"><?php echo tr_wd('Footer-1_title'); ?></label>
            <div class="col-sm-8">
          ...
          <div class="form-group row">
            <label class="control-label col-md-3"><?php echo tr_wd('footer-1_content'); ?></label>
            <div class="col-md-8">
          ...
          <div class="form-group row">
            <label class=" col-sm-3 control-label"><?php echo tr_wd('Footer-2_title'); ?></label>
            <div class="col-sm-8">
          ...
          <div class="form-group row">
            <label class="control-label col-md-3"><?php echo tr_wd('footer-2_content'); ?></label>
            <div class="col-md-8">
          ...
          <div class="form-group row">
            <label class=" col-sm-3 control-label"><?php echo tr_wd('Footer-3_title'); ?></label>
            <div class="col-sm-8">
          ...
          <div class="form-group row">
            <label class="control-label col-md-3"><?php echo tr_wd('footer-3_content'); ?></label>
            <div class="col-md-8">
          ...
          <div class="form-group row">
            <label class="control-label col-md-3"><?php echo tr_wd('copyright_text'); ?></label>
            <div class="col-md-8">
