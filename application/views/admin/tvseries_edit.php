          ...
          <div class="card-block">
            ...
            <div class="form-group">
              ...
              <select class="form-control select2" name="video_type[]" multiple="multiple">
                ...
                <option value="<?php echo $video_type['video_type_id']; ?>" <?php  if(preg_match('/\b'.$video_type['video_type_id'].'\b/', $video['video_type'])){ echo "selected";} ?>><?php echo $video_type['video_type']; ?></option>
                <?php endforeach; ?>
              </select>
            </div>
            <div class="form-group">
      ...
      <div class="card-block">
        ...
        <div class="row">            
            <div class="col-sm-6 pull-right">
                <button type="submit" class="btn btn-primary pull-right waves-effect"> <span class="btn-label"><i class="fa fa-floppy-o"></i></span>Save Changes</button>
            </div>
        </div>
