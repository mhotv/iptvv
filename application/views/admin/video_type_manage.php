  ...
  <div class="row">
    <div class="col-sm-6">
      <?php echo form_open(base_url() . 'admin/video_type/add/' , array('class' => 'form-horizontal group-border-dashed', 'enctype' => 'multipart/form-data'));?>
        <h4 class="text-center panel-title"><?php echo tr_wd('add_new_video_type'); ?></h4>
        <hr>
        ...
        <table id="datatable-buttons" class="table table-striped">
          <thead>
            <tr>
              ...
              <th><?php echo tr_wd('menu_bar'); ?></th>
              <th><?php echo tr_wd('footer'); ?></th>
              <th>_<?php echo tr_wd('option'); ?>_</th>
            </tr>
          </thead>
          <tbody>
            <?php $sl = 1;
            ...
            <tr id='row_<?php echo $video_type['video_type_id'];?>'>
              ...
              <td>
                <div class="btn-group m-b-20"> <a data-toggle="modal" data-target="#mymodal" data-id="<?php echo base_url() . 'admin/view_modal/video_type_edit/'. $video_type['video_type_id'];?>" id="menu" title="<?php echo tr_wd('edit'); ?>" class="btn btn-sm btn-icon"><i class="fa fa-pencil"></i></a> <a title="<?php echo tr_wd('delete'); ?>" class="btn btn-sm btn-icon" onclick="delete_row(<?php echo " 'video_type' ".','.$video_type['video_type_id'];?>)" class="delete"><i class="fa fa-remove"></i></a> </div>
              </td>
            </tr>
            <?php endforeach;?>
          </tbody>
