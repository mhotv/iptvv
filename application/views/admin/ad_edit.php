            ...
            <div class="panel panel-border panel-primary">
                <div class="panel-heading">
                    <h3 class="panel-title">
                        Edit <?php echo $ads_info->ads_name; ?> ads
                    </h3>
                </div>
                <div class="panel-body">
                    ...
                    <div id="ad_image_section" style="display:none;">
                        ...
                        <div class="form-group">
                            <label class=" col-sm-3 control-label">Target URL</label>
                            <div class="col-sm-9">
                    ...
                    <div id="ad_code_section" style="display:none;">
                        <div class="form-group">
                            <label class="control-label col-md-3">Ads Code(Google adsense,html)</label>
                            <div class="col-md-9">
...
<script>
    jQuery(document).ready(function() {
        ...
        $('#thumb_file').click(function() {
            $('#thumbnail_content').html('<input type="file" id="thumbnail_file" onchange="showImg(this);" name="ads_image" class="filestyle" data-input="false" accept="image/*"></div>');
        });
...
<script>
    $(document).ready(function() {
        <?php if($ads_info->ads_type == "image" && $ads_info->enable=="1"): ?>
