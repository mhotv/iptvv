            ...
            <tr id="row_<?php echo $video_file['video_file_id']; ?>">
              ...
              <td>
                <div class="btn-group">
                  ...
                  <?php endif; ?>
                    <li><a class="dropdown-item" title="<?php echo tr_wd('delete'); ?>" href="#" onclick="delete_row('video_file',<?php echo urldecode($video_file['video_file_id']);?>)" class="delete"><?php echo tr_wd('delete'); ?></a> </li>
                  </ul>
                </div>
              </td>
            </tr>             
