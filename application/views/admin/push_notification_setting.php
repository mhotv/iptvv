        ...
        <div class="col-md-12">
          ...
          <div class="panel panel-border panel-primary">
            <div class="panel-heading">
              <h3 class="panel-title"><?php echo tr_wd('push_notification_setting'); ?></h3>
            </div>
            <div class="panel-body"> 
              <!-- panel  -->
              <div class="form-group row">
                <label class="control-label col-md-3"><?php echo tr_wd('push_notification'); ?></label>
                <div class="col-sm-9">              
              ...
              <div class="form-group row">
                <label class=" col-sm-4 control-label"><?php echo tr_wd('onesignal_api_keys'); ?></label>
                <div class="col-sm-9">
              ...
              <div class="form-group row">
                <label class=" col-sm-4 control-label"><?php echo tr_wd('onesignal_appid'); ?></label>
                <div class="col-sm-9">
              ...
              <div class="form-group row">
                <label class=" col-sm-4 control-label"><?php echo tr_wd('onesignal_actionmessage'); ?></label>
                <div class="col-sm-9">
              ...
              <div class="form-group row">
                <label class=" col-sm-4 control-label"><?php echo tr_wd('onesignal_acceptbuttontext'); ?></label>
                <div class="col-sm-9">
              ...
              <div class="form-group row">
                <label class=" col-sm-4 control-label"><?php echo tr_wd('onesignal_cancelbuttontext'); ?></label>
                <div class="col-sm-9">
