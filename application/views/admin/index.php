      ...
      <ul class="app-nav">
        ...
        <li class="dropdown"><a class="app-nav__item" href="#" data-toggle="dropdown" aria-label="Open Profile Menu"><img  src="<?php echo $this->common_model->get_img('user', $this->session->userdata('user_id')).'?'.time();?>" class="img-circle" alt="photo" height="20"></a>
          <ul class="dropdown-menu settings-menu dropdown-menu-right">
            <li><a class="dropdown-item" href="<?php echo base_url();?>admin/manage_profile"><i class="fa fa-user fa-lg"></i> <?php echo tr_wd('profile'); ?></a></li>
            <li><a class="dropdown-item" href="<?php echo base_url();?>admin/manage_profile"><i class="fa fa-lock fa-lg" aria-hidden="true"></i> <?php echo tr_wd('change_password'); ?></a></li>
            <li><a class="dropdown-item" href="<?php echo base_url();?>login/logout"><i class="fa fa-sign-out fa-lg"></i> <?php echo tr_wd('logout'); ?></a></li>
          </ul>
        </li>
      </ul>
    </header>
