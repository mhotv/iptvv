        ...
        <div class="col-md-12">
          ...
          <div class="panel panel-border panel-primary">
            <div class="panel-heading">
              <h3 class="panel-title"><?php echo tr_wd('send_push_notification'); ?></h3>
            </div>
            <div class="panel-body"> 
              <!-- panel  -->              
              <div class="form-group row">
                <label class=" col-sm-4 control-label"><?php echo tr_wd('headings'); ?></label>
                <div class="col-sm-8">
                  <input type="text" name="headings" class="form-control" value="New Movie Release" required>
                </div>
              </div>
              <div class="form-group row">
                <label class=" col-sm-4 control-label"><?php echo tr_wd('message'); ?></label>
                <div class="col-sm-8">
