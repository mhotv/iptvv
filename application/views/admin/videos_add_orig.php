        ...
        <div class="card cta cta--featured p-a">
          ...
          <div class="card-block">
            ...
            <div class="form-group">
              ...
              <select class="form-control" name="actor[]" multiple="multiple" id="actor">
        ...
        $.ajax({
            ...
            success:function(response) {
                ...
                for( var i = 0; i<len; i++) {
                    ...
                    newOptions += '<option value="' + id + '">' + name + '</option>';
                }
                $("#actor").append(newOptions);
                $("#director").append(newOptions);
                $("#writer").append(newOptions);
            }
        });
        return true;
    }
