                  ...
                  <td>
                    <div class="btn-group">
                      ...
                      <ul class="dropdown-menu" role="menu">
                        ...
                        <?php endif; ?>
                        <li><a class="dropdown-item" title="<?php echo tr_wd('delete'); ?>" href="#" onclick="delete_row('episodes',<?php echo urldecode($video_file['episodes_id']);?>)" class="delete"><?php echo tr_wd('delete'); ?></a> </li>
                      </ul>
                    </div>
                  </td>
                </tr>             
