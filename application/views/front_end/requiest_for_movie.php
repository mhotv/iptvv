    ...
    <div class="container">
        <div class="row">
            <div class="col-md-6 col-xs-12">
                <h2 class="block-title text-center">Send a Request<br>
                    <small>Movie not avilable? Send Us A Note Using The Form Below.</small>
                </h2>

                <div class="sendus">
                    <div class="movie-heading m-b-20"> <span>Send Us Request</span>
            ...
            <div class="col-md-6 col-xs-12">
                <address class="m-l-50">
                    <h2 class="block-title text-center">Or Contact Us<br>
